...
from routes.users_api import router as user_api_router
...
app.include_router(event_router, prefix="/event_router")
app.include_router(user_api_router, prefix="/user_api_router")
